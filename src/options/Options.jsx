  ...
  return (
    <div className="w-[calc(100%-260px)] xl:w-[calc(100%-130px)] mx-auto my-24 relative z-10" id="about">
      ...
      <div className="xl:w-[calc(100%-130px)] xl:mx-auto lg:mx-auto lg:w-full">
        <div className="flex justify-center gap-4 flex-wrap">
          <div className="basis-[460px] overflow-hidden rounded-lg shadow-lg flex flex-col">
            <div className="relative">
              ...
              <p className="absolute top-3 left-4 text-white font-semibold text-xl">
                MIRACLE RESORT
              </p>
              <span className="absolute right-10 top-3 text-2xl text-amber-300 rounded-full">
        ...
        <span className="absolute left-1/2 -translate-x-1/2 -bottom-[75px]">
          <i className="fa-solid fa-circle-down text-3xl text-black"></i>
        </span>
      </div>
    </div>
  );
